...
class WinesControllerTest < ActionController::TestCase
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post :create, wine: { invoice: @wine.invoice, name: @wine.name, price: @wine.price, vivino_score: @wine.vivino_score }
    end
  ...
  test "should update wine" do
    patch :update, id: @wine, wine: { invoice: @wine.invoice, name: @wine.name, price: @wine.price, vivino_score: @wine.vivino_score }
    assert_redirected_to wine_path(assigns(:wine))
  end
